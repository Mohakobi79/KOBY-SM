...
const handler = async (m, { conn, usedPrefix, command, text }) => {
  try {
    ...
    let result = await luminAi(text, m.sender, `nama kamu adalah Elaina, pembuatmu adalah ManzKenz, lawan bicaramu adalah ${await conn.getName(m.sender)}, dan kamu menjawab menggunakan bahasa indonesia yang santai`);
